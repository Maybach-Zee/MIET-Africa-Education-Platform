...
var m = function() {
  function e3(e4) {
    ...
    this.container = void 0, this.form = void 0, this.input = void 0, this.handleSubmit = void 0, this.hasError = false, this.container = s("div", l("geosearch", i2.container)), this.form = s("form", l("", i2.form), this.container, { autocomplete: "none", onClick: a, onDblClick: a, touchStart: a, touchEnd: a }), this.input = s("input", l("glass", i2.input), this.form, { type: "text", placeholder: n2 || "search", name: "geosearch", onInput: this.onInput, onKeyUp: function(e5) {
...
var w = { options: t({}, y), classNames: t({}, y.classNames), initialize: function(r2) {
  var n2, o2, i2, a2, l2 = this;
  if (!e)
    throw new Error(b);
  if (!r2.provider)
    throw new Error("Provider is missing from options");
  this.options = t({}, y, r2), this.classNames = t({}, this.classNames, r2.classNames), this.markers = new e.FeatureGroup(), this.classNames.container += " leaflet-geosearch-" + this.options.style, this.searchElement = new m({ searchLabel: this.options.searchLabel, classNames: { container: this.classNames.container, form: this.classNames.form, input: this.classNames.input }, handleSubmit: function(e3) {
    return l2.onSubmit(e3);
  } }), this.button = s("a", this.classNames.button, this.searchElement.container, { title: this.options.searchLabel, "aria-label": this.options.searchLabel, href: "#", onClick: function(e3) {
    return l2.onClick(e3);
  } }), e.DomEvent.disableClickPropagation(this.button), this.resetButton = s("button", this.classNames.resetButton, this.searchElement.form, { text: this.options.resetButton, "aria-label": this.options.clearSearchLabel, onClick: function() {
...
var x = function(e3) {
  function t2() {
    for (var t3, r2 = arguments.length, n3 = new Array(r2), o2 = 0; o2 < r2; o2++)
      n3[o2] = arguments[o2];
    return (t3 = e3.call.apply(e3, [this].concat(n3)) || this).searchUrl = "https://restapi.amap.com/v3/geocode/geo", t3;
  }
  r(t2, e3);
  var n2 = t2.prototype;
  return n2.endpoint = function(e4) {
    var t3 = e4.query, r2 = "string" == typeof t3 ? { address: t3 } : t3;
    return r2.output = "JSON", this.getUrl(this.searchUrl, r2);
  }, n2.parse = function(e4) {
    var t3;
    return (null != (t3 = e4.data.geocodes) ? t3 : []).map(function(e5) {
      return { x: Number(e5.location.substring(0, e5.location.indexOf(","))), y: Number(e5.location.substring(e5.location.indexOf(",") + 1)), label: e5.formatted_address, bounds: null, raw: e5 };
    });
  }, t2;
}(U);
var k = function(e3) {
...
var C = function(e3) {
  function t2(t3) {
    var r2;
    void 0 === t3 && (t3 = {}), (r2 = e3.call(this, t3) || this).searchUrl = void 0, r2.reverseUrl = void 0;
    var n3 = "https://data.geopf.fr/geocodage";
    return r2.searchUrl = t3.searchUrl || n3 + "/search", r2.reverseUrl = t3.reverseUrl || n3 + "/reverse", r2;
  }
  r(t2, e3);
  var n2 = t2.prototype;
...
var P = function(e3) {
  ...
  return n2.endpoint = function(e4) {
    ...
    return (Array.isArray(e4.data.results) ? e4.data.results : [e4.data.results]).map(function(e5) {
      var t3 = null;
      return e5.bbox && (t3 = [[parseFloat(e5.bbox.lat1), parseFloat(e5.bbox.lon1)], [parseFloat(e5.bbox.lat2), parseFloat(e5.bbox.lon2)]]), { x: Number(e5.lon), y: Number(e5.lat), label: e5.formatted, bounds: t3, raw: e5 };
    });
  }, t2;
}(U);
var R = function(e3) {
...
var O = class _O {
  constructor({ apiKey: e3, authReferrerPolicy: t2, channel: r2, client: n2, id: o2 = "__googleMapsScriptId", language: i2, libraries: s2 = [], mapIds: a2, nonce: l2, region: c2, retries: u2 = 3, url: h2 = "https://maps.googleapis.com/maps/api/js", version: p2 }) {
    if (this.callbacks = [], this.done = false, this.loading = false, this.errors = [], this.apiKey = e3, this.authReferrerPolicy = t2, this.channel = r2, this.client = n2, this.id = o2 || "__googleMapsScriptId", this.language = i2, this.libraries = s2, this.mapIds = a2, this.nonce = l2, this.region = c2, this.retries = u2, this.url = h2, this.version = p2, _O.instance) {
      if (!I(this.options, _O.instance.options))
        throw new Error(`Loader must not be called again with different options. ${JSON.stringify(this.options)} !== ${JSON.stringify(_O.instance.options)}`);
      return _O.instance;
    }
    _O.instance = this;
  }
...
var F = function(e3) {
  function t2(t3) {
    var r2;
    return (r2 = e3.call(this, t3) || this).loader = null, r2.geocoder = null, "undefined" != typeof window && (r2.loader = new O(t3).load().then(function(e4) {
...
var _ = function(e3) {
  function t2() {
    for (var t3, r2 = arguments.length, n3 = new Array(r2), o2 = 0; o2 < r2; o2++)
      n3[o2] = arguments[o2];
    return (t3 = e3.call.apply(e3, [this].concat(n3)) || this).searchUrl = "https://geocode.search.hereapi.com/v1/geocode", t3;
  }
  r(t2, e3);
  var n2 = t2.prototype;
  return n2.endpoint = function(e4) {
...
var T = function(e3) {
  ...
  return n2.endpoint = function(e4) {
    ...
    return e4.data.results.map(function(e5) {
      var t3 = null;
      return e5.bounds && (t3 = [[e5.bounds.southwest.lat, e5.bounds.southwest.lng], [e5.bounds.northeast.lat, e5.bounds.northeast.lng]]), { x: e5.geometry.lng, y: e5.geometry.lat, label: e5.formatted, bounds: t3, raw: e5 };
    });
...
var G = function(e3) {
  function n2(r2) {
    var n3;
    void 0 === r2 && (r2 = {}), (n3 = e3.call(this, t({}, r2, { params: t({ bq: "type:gemeente^0.5 type:woonplaats^0.5 type:weg^1.0 type:postcode^1.5 type:adres^2.0", fl: "id,weergavenaam,centroide_ll", rows: 5 }, r2.params) })) || this).searchUrl = void 0, n3.reverseUrl = void 0;
    var o3 = "https://api.pdok.nl/bzk/locatieserver/search/v3_1";
    return n3.searchUrl = o3 + "/suggest", n3.reverseUrl = o3 + "/reverse", n3;
  }
  r(n2, e3);
  var o2 = n2.prototype;
  return o2.endpoint = function(e4) {
    var t2 = e4.query;
    return this.getUrl(e4.type === h.REVERSE ? this.reverseUrl : this.searchUrl, "string" == typeof t2 ? { q: t2 } : t2);
  }, o2.parse = function(e4) {
    var r2 = e4.data;
    return r2.response.docs.map(function(e5) {
      var n3 = e5.centroide_ll.replace(/POINT\(|\)/g, "").trim().split(" ").map(Number), o3 = e5.weergavenaam;
      return r2.highlighting[e5.id].suggest && (o3 = r2.highlighting[e5.id].suggest[0]), { x: n3[0], y: n3[1], label: e5.weergavenaam, bounds: null, raw: t({}, e5, { highlight: o3 }) };
    });
  }, o2.search = function(e4) {
    try {
      var t2 = this, r2 = t2.endpoint({ query: e4.query });
      return Promise.resolve(fetch(r2).then(function(e5) {
        return e5.json();
      }).then(function(e5) {
        if (e5.response.numFound < 1 && e5.spellcheck.collations.length >= 2) {
          var r3 = t2.endpoint({ query: e5.spellcheck.collations[1].collationQuery });
          return fetch(r3).then(function(e6) {
            return e6.json();
          });
        }
        return e5;
      })).then(function(e5) {
        return t2.parse({ data: e5 });
      });
    } catch (e5) {
      return Promise.reject(e5);
    }
...
export {
  ...
  E as GeoSearchControl,
  P as GeoapifyProvider,
  N as GeocodeEarthProvider,
  F as GoogleProvider,
  _ as HereProvider,
  U as JsonProvider,
  ...
  D as MapBoxProvider,
  T as OpenCageProvider,
  M as OpenStreetMapProvider,
  G as PdokNlProvider,
  R as PeliasProvider,
  E as SearchControl,
  m as SearchElement
